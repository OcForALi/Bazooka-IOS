 ...
 *  @constant MODE_CAUDRECORD 卡录音模式。
 *  @constant MODE_UAUDRECORD U盘录音模式。
 *  @constant MODE_USBSPEAKER USB音箱模式。
 *  @constant MODE_CHARGE   充电模式。
 *
 */
typedef enum {
    MODE_UNKNOWN    = -1,
 ...
 *  @constant FeatureUSBSpeaker   支持USB音箱功能标志。
 *  @constant FeatureOTA          支持OTA功能标志。
 *
 */
typedef enum {
    FeatureA2dp         = 0,
 ...
 *  @constant STATE_WAITING  等待状态(如收音机搜台)。
 *
 */
typedef enum {
    STATE_UNKNOWN = -1,
 ...
 *  @abstract 音箱录音功能状态。
 *
 *  @constant REC_UNKNOWN   未知或异常状态。
 *  @constant REC_RECORDING 正在录音状态。
 *  @constant REC_PAUSED    录音暂停状态。
 *  @constant REC_STOPPED   录音停止状态。
 */
typedef enum {
    REC_UNKNOWN     = -1,
    REC_RECORDING   = 0,
