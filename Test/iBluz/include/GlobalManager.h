...
/*!
 *  @method hotplugUSBChanged:
 *
 *  @param visibility USB线插拔状态
 *
 *  @abstract USB线插拔状态变化
 */
...
/*!
 *  @method daeModeChangedWithVBASS:treble:surround:
 *
 *  @param vbassEnable 虚拟低音音效使能状态
 *  @param trebleEnable 高音增强音效使能状态
 *  @param surroundEnable 虚拟环绕音音效使能状态
 *
 *  @abstract DAE音效模式变化
 */
...
/*!
 *  @method daeModeChanged:
 *
 *  @param daeOpts DAE虚拟音效参数
 *
 *  @abstract DAE音效模式变化
 */
...
/*!
 *  @method setEffectDAE:vbassState:trebleState:surroundState:
 *
 *  @param daeEnable 数字音效使能状态
 *  @param vbassEnable 虚拟低音音效使能状态
 *  @param trebleEnable 高音增强音效使能状态
 *  @param surroundEnable 虚拟环绕音音效使能状态
 *
 ...
 *  @seealso EQMode
 */
-(void)setEffectDAE:(BOOL)daeEnable vbassState:(BOOL)vbassEnable trebleState:(BOOL)trebleEnable surroundState:(BOOL)surroundEnable;
/*!
 *  @method setEffectDAE:options:
 *
 *  @param daeEnable 数字音效使能状态
 *  @param daeOpts 数字音效参数
 *
 *  @abstract 设置音箱的音效模式和参数
 *
 *  @seealso SoundEffect
 *  @seealso EQMode
 */
-(void)setEffectDAE:(BOOL)daeEnable options:(int)daeOpts;
/*!
...
-(void)sendCustomCommand:(NSData*)data;
/*!
