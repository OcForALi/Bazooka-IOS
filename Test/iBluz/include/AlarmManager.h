...
/*!
 *  @method alarmParamsArrived:
 *
 *  @param params 闹钟设置参数
 *
 *  @abstract 获取到闹钟设置参数对象
 *
 *  @seealso setAlarmParams:
 */
-(void)alarmParamsArrived:(AlarmParams*)params;
...
/*!
 *  @method getAlarmParams
 *
 *  @abstract 获取闹钟设置参数。
 *
 *  @seealso alarmParamsArrived:
 */
-(void)getAlarmParams;

/*!
 *  @method setAlarmParams:
 *
 *  @abstract 闹钟参数设置。
 */
-(void)setAlarmParams:(AlarmParams*)params;
